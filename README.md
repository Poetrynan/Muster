...
1. Download the latest installer from the [Releases](https://github.com/Poetrynan/Muster/releases) page or [Official Site](https://poetrynan.github.io/Muster/):
   - **Windows**: `Muster_0.2.8_x64-setup.exe` (or `.msi`)
   - **macOS (Apple Silicon M1/M2/M3/M4)**: `Muster_0.2.8_aarch64.dmg`
   - **macOS (Intel)**: `Muster_0.2.8_x64.dmg`
   - **Linux (x86_64)**: `Muster_0.2.8_amd64.AppImage` (or `muster_0.2.8_amd64.deb`, `muster-bin` on AUR)
