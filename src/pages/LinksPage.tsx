...
const SITES: SiteLink[] = [
  // — 官方统一门户 —
  {
    ...
    url: "https://home.student.monash/",
    host: "home.student.monash",
  ...
  // — 选课 / 排课 / 考勤 —
  {
    ...
    url: "https://my.monash.edu.au/wes/",
    host: "my.monash.edu.au/wes",
    faviconDomain: "monash.edu",
    category: "enrol",
  },
  {
    ...
    url: "https://www.monash.edu/students/admin/timetables/allocate/login",
    host: "monash.edu/students/admin/timetables/allocate",
    faviconDomain: "monash.edu",
    category: "enrol",
  },
  {
  ...
  },
  {
    ...
    url: "https://www.monash.edu/students/admin/assessments/extensions-special-consideration",
    host: "monash.edu/students/admin/assessments/…",
    faviconDomain: "monash.edu",
    category: "learning",
  },
  // — 咨询 / 图书馆 / 校园服务 —
  ...
  },
  {
    id: "careers",
    name: {
      en: "Careers & Employability",
      zh: "职业生涯与就业",
      ja: "キャリア・就職支援",
      ko: "커리어·취업 지원",
    },
    desc: {
      en: "Official careers hub for students: internships, industry experience, resume & interview workshops, career advice and job opportunities.",
      zh: "学校官方职业发展与就业能力中心：实习与行业经验、简历与面试工作坊、职业咨询与校内机会。",
      ja: "Monash の学生向けキャリアセンター。インターンシップや業界経験、履歴書・面接ワークショップ、キャリア相談、求人情報。",
      ko: "Monash 공식 커리어 센터: 인턴십과 산업 경험, 이력서·면접 워크숍, 커리어 상담, 교내 기회.",
    },
    detail: {
      en: "The careers and employability portal for current students. Explore internships and industry-based learning, leadership programs and volunteering, job-ready skills workshops (interviews, resumes, applications), and networking events. Find work opportunities including part-time and casual roles; CareerEdge offers personalised guidance, digital badges showcase your achievements, and there are dedicated services for Malaysia campus and PhD students.",
      zh: "在校生职业生涯与就业能力门户。探索实习与行业学习项目、领导力项目与志愿者机会、求职技能工作坊（面试、简历、投递）与人脉拓展活动；可查找兼职与临时工作机会，CareerEdge 提供个性化职业指导，数字徽章帮你展示成就，马来西亚校区与博士生另有专属服务。",
      ja: "在学生向けのキャリア・就職力ポータル。インターンシップや産学連携プログラム、リーダーシップ研修・ボランティア、就職スキルワークショップ（面接・履歴書・応募）、ネットワーキングイベントを探索し、アルバイト求人も探せます。CareerEdge の個別指導やデジタルバッジのほか、マレーシアキャンパス・博士課程学生向けサービスも。",
      ko: "재학생 커리어·취업 역량 포털입니다. 인턴십과 산학 프로젝트, 리더십 프로그램·봉사, 취업 스킬 워크숍(면접·이력서·지원), 네트워킹 행사를 탐색하고 파트타임·단기 일자리를 찾을 수 있습니다. CareerEdge 맞춤 지원, 디지털 배지, 말레이시아 캠퍼스·박사과정 전용 서비스도 제공합니다.",
    },
    url: "https://www.monash.edu/students/careers",
    host: "monash.edu/students/careers",
    faviconDomain: "monash.edu",
    category: "campus",
  },
  {
